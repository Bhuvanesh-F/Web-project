...
### Ayman Fokeer · Student ID: 2412575
...
Individual contributions are verifiable on the `feature/auth-laravel` branch. Commit history reflects incremental development of each deliverable with descriptive commit messages.
...
*VitalCare — ICT2213Y Group Project | University of Mauritius*  
*Branch: `feature/auth-laravel` | Student: Ayman Fokeer (2412575)*
